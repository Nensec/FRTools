...
namespace Discord.WebSocket
{
    ...
    public class SocketTextChannel : SocketGuildChannel, ITextChannel, ISocketMessageChannel
    {
        ...
        public async Task<RestUserMessage> SendFilesAsync(IEnumerable<KeyValuePair<string, Stream>> files, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null)
            => await ChannelHelper.SendFileAsync(this, Discord, files, text, isTTS, embed, allowedMentions, messageReference, options, isSpoiler);
        public async Task<RestUserMessage> SendFilesAsync(IEnumerable<string> filePaths, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null)
        ...
        async Task<IUserMessage> IMessageChannel.SendFilesAsync(IEnumerable<string> filePaths, string text, bool isTTS, Embed embed, RequestOptions options, bool isSpoiler, AllowedMentions allowedMentions, MessageReference messageReference)
            => await SendFilesAsync(filePaths, text, isTTS, embed, options, isSpoiler, allowedMentions, messageReference).ConfigureAwait(false);
        async Task<IUserMessage> IMessageChannel.SendFilesAsync(IEnumerable<KeyValuePair<string, Stream>> files, string text, bool isTTS, Embed embed, RequestOptions options, bool isSpoiler, AllowedMentions allowedMentions, MessageReference messageReference)
            => await SendFilesAsync(files, text, isTTS, embed, options, isSpoiler, allowedMentions, messageReference).ConfigureAwait(false);
    }
}
