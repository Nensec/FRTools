...
namespace Discord.WebSocket
{
    ...
    public interface ISocketMessageChannel : IMessageChannel
    {
        ...
        new Task<RestUserMessage> SendFilesAsync(IEnumerable<string> filePaths, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null);
        /// <summary>
        ///     Sends a file to this message channel with an optional caption.
        /// </summary>
        /// <remarks>
        ...
        new Task<RestUserMessage> SendFilesAsync(IEnumerable<KeyValuePair<string, Stream>> files, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null);
