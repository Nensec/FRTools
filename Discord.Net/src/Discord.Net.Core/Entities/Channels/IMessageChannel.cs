...
namespace Discord
{
    ...
    public interface IMessageChannel : IChannel
    {
        ...
        Task<IUserMessage> SendFilesAsync(IEnumerable<string> filePaths, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null);
        ...
        Task<IUserMessage> SendFilesAsync(IEnumerable<KeyValuePair<string, Stream>> files, string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null, MessageReference messageReference = null);
