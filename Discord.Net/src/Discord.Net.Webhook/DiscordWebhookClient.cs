...
namespace Discord.Webhook
{
    ...
    public class DiscordWebhookClient : IDisposable
    {
        ...
        public Task<ulong> SendFileAsync(IEnumerable<string> filePaths, string text, bool isTTS = false,
            ...
            => WebhookClientHelper.SendFileAsync(this, filePaths, text, isTTS, embeds, username, avatarUrl, allowedMentions, options, isSpoiler);
        ...
        public Task<ulong> SendFileAsync(IEnumerable<KeyValuePair<string, Stream>> streams, string text, bool isTTS = false,
            IEnumerable<Embed> embeds = null, string username = null, string avatarUrl = null, RequestOptions options = null, bool isSpoiler = false, AllowedMentions allowedMentions = null)
            => WebhookClientHelper.SendFileAsync(this, streams, text, isTTS, embeds, username, avatarUrl, allowedMentions, options, isSpoiler);
