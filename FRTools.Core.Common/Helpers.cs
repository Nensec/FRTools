...
namespace FRTools.Core.Common
{
    public static class Helpers
    {
        ...
        public static string GetProxyDummyDragonSkinUrl(int dragonBreed, int gender, int itemId) => $"https://{Environment.GetEnvironmentVariable("WEBSITE_HOSTNAME")}/proxy/dragon/skin/{dragonBreed}/{gender}/{itemId}";
        ...
        public static string GetProxyDummyDragonGeneUrl(int dragonBreed, int gender, int itemId) => $"https://{Environment.GetEnvironmentVariable("WEBSITE_HOSTNAME")}/proxy/dragon/gene/{dragonBreed}/{gender}/{itemId}";
        ...
        public static string GetProxyDummyDragonApparelUrl(int dragonBreed, int gender, int itemId) => $"https://{Environment.GetEnvironmentVariable("WEBSITE_HOSTNAME")}/proxy/dragon/apparel/{dragonBreed}/{gender}/{itemId}";
        public static string GetProxyIconUrl(int itemId) => $"https://{Environment.GetEnvironmentVariable("WEBSITE_HOSTNAME")}/proxy/icon/{itemId}";
